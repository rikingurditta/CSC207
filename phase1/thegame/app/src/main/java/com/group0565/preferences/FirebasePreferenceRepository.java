...
public class FirebasePreferenceRepository implements IAsyncPreferencesRepository {
  ...
  public FirebasePreferenceRepository(String currUser) {
   ...
   */
  @Override
  public LiveData<List<IPreference>> observeAllUserPreferences() {
   ...
   */
  @Override
  public void updatePreference(IPreference preference) {
   ...
   */
  @Override
  public void deletePreference(IPreference preference) {
