...
public class ScoreCalculator {
   ...
   */
  public static SessionHitObjects constructSessionHitObjects(
      Beatmap beatmap, List<ArchiveInputEvent> archive) {
    ...
    HashMap<Scores, Integer> scores =
        new HashMap<>(); // Stores the number of hits for every accuracy (Score)
   ...
   */
  public static Scores computeHitScore(
      long msStart, long hitTime, long[] distribution, boolean strict) {
