...
public class FullHistoryDisplayer extends GameMenu {
  ...
  public void init() {
    ...
    center =
        new ThemedPaintCan(SET, CenterPaintName)
            .init(getGlobalPreferences(), getEngine().getGameAssetManager());
    ThemedPaintCan countPaint =
        new ThemedPaintCan(SET, CountPaintName)
            .init(getGlobalPreferences(), getEngine().getGameAssetManager());
    ...
    LanguageText difficultyLabel =
        new LanguageText(
            getGlobalPreferences(), getEngine().getGameAssetManager(), SET, DifficultyToken);
    // @formatter:off
    this.build()
        .add(
            BackgroundName,
        ...
        .add(
            ...
            new GradeRenderer(
                GradeSize,
                () ->
                    (objectsSource.getValue() == null
                        ? null
                        : Grade.num2Grade(objectsSource.getValue().getGrade()))))
        .addAlignment(Left, THIS, Left, MARGINS.getX())
        .addAlignment(Top, THIS, Top, MARGINS.getY())
        .add(
            S300Name,
            new HitScoreRenderer(SHeight, () -> Scores.S300)
                .build()
        ...
        .add(
            ...
            new TextRenderer(
                    () ->
                        (objectsSource.getValue() == null
                            ? "0"
                            : String.valueOf(objectsSource.getValue().getS300())),
                    countPaint)
                .build()
                .setSelfEnable(() -> objectsSource.getValue() != null)
                .close())
        ...
        .add(
            S150Name,
            new HitScoreRenderer(SHeight, () -> Scores.S150)
                .build()
                .setSelfEnable(() -> objectsSource.getValue() != null)
                .close())
        .addAlignment(Left, THIS, Left, MARGINS.getX())
        ...
        .add(
            ...
            new TextRenderer(
                    () ->
                        (objectsSource.getValue() == null
                            ? "0"
                            : String.valueOf(objectsSource.getValue().getS150())),
                    countPaint)
                .build()
                .setSelfEnable(() -> objectsSource.getValue() != null)
                .close())
        ...
        .add(
            S50Name,
            new HitScoreRenderer(SHeight, () -> Scores.S50)
                .build()
                .setSelfEnable(() -> objectsSource.getValue() != null)
                .close())
        .addAlignment(Left, THIS, Left, MARGINS.getX())
        ...
        .add(
            ...
            new TextRenderer(
                    () ->
                        (objectsSource.getValue() == null
                            ? "0"
                            : String.valueOf(objectsSource.getValue().getS50())),
                    countPaint)
                .build()
                .setSelfEnable(() -> objectsSource.getValue() != null)
                .close())
        ...
        .add(
            S0Name,
            new HitScoreRenderer(SHeight, () -> Scores.S0)
                .build()
                .setSelfEnable(() -> objectsSource.getValue() != null)
                .close())
        .addAlignment(Left, THIS, Left, MARGINS.getX())
        ...
        .add(
            ...
            new TextRenderer(
                    () ->
                        (objectsSource.getValue() == null
                            ? "0"
                            : String.valueOf(objectsSource.getValue().getS0())),
                    countPaint)
                .build()
                .setSelfEnable(() -> objectsSource.getValue() != null)
                .close())
        ...
        .add(
            ...
            new TextRenderer(
                    () ->
                        (objectsSource.getValue() == null
                            ? "0"
                            : String.valueOf(objectsSource.getValue().getScore())),
                    scorePaint)
                .build()
                .setSelfEnable(() -> objectsSource.getValue() != null)
                .close())
        ...
        .add(
            ...
            new TextRenderer(
                    () ->
                        (objectsSource.getValue() == null
                            ? "0"
                            : String.valueOf(objectsSource.getValue().getMaxCombo())),
                    comboPaint)
                .build()
                .setSelfEnable(() -> objectsSource.getValue() != null)
                .close())
            ...
            new TextRenderer(
                    () ->
                        difficultyLabel.getValue()
                            ...
                            + (objectsSource.getValue() == null
                                ? ""
                                : String.valueOf(objectsSource.getValue().getDifficulty())),
                    difficultyPaint)
                .build()
                .setSelfEnable(() -> objectsSource.getValue() != null)
                .close())
        ...
        .add(
            ...
            new TextRenderer(
                    () ->
                        (objectsSource.getValue() == null
                            ? "0"
                            : objectsSource.getValue().getDatetime()),
                    datePaint)
                .build()
                .setSelfEnable(() -> objectsSource.getValue() != null)
                .close())
        ...
        .add(
            CheatName,
            new BitmapDrawer(CHEAT_SIZE, ButtonBitmap.CheatIcon::getBitmap)
                .build()
                .setSelfEnable(
                    () ->
                        (objectsSource.getValue() != null && objectsSource.getValue().hasCheats()))
                .close())
        .addAlignment(Left, GradeName, Right, INTERNAL_MARGINS.getX())
        .addAlignment(Bottom, GradeName, Bottom)
        .add(
            ReplayName,
            new Button(REPLAY_SIZE, ButtonBitmap.ReplayButton.getBitmap())
                .build()
  ...
  private class GraphRenderer extends GameObject {
    ...
    public void calculate() {
      ...
      //                double sum = 0;
      //                HitObject hitObject;
      //                while (counter < hitObjects.size() && (hitObject =
      // hitObjects.get(counter++)).getMsStart() < iend) {
      //                    sum +=
      // toPct(hitObject.computeScore(ScoreCalculator.calculateDistribution(objects.getDifficulty())));
      //                    count++;
      //                }
    ...
    public void draw(Canvas canvas) {
      ...
      for (int i = 0; i < samples - 1; i++) {
        ...
        if (c <= MIN && n <= MIN) {
          ...
          canvas.drawLine(
              (float) ws, (float) (c * h), (float) cx, (float) (MIN * h), c <= MIN ? red : green);
          canvas.drawLine(
              (float) cx, (float) (MIN * h), (float) we, (float) (n * h), n <= MIN ? red : green);
        }
      }
    }
