 ...
 *
 * <p>This class is simple enough to not warrent getters and setters.
 */
public class ArchiveInputEvent {
   ...
   *
   * @param position The position of the Input Event, in 0-1, with 0 being the left side and 1 for
   *     the right
