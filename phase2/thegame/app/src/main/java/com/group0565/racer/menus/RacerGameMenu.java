...
public class RacerGameMenu extends GameMenu implements Observable {
  ...
  private static final ThemedPaintCan BACKGROUND_PAINT_CAN =
      new ThemedPaintCan("Racer", "Background.Background");
  ...
  private static final ThemedPaintCan LANE_PAINT_CAN =
      new ThemedPaintCan("Racer", "Divider.Divider");
  ...
  public void init() {
    ...
    this.build()
        .add(
            "Left Lane",
            (leftLane = new Lane(new Vector(getSize().getX() / 3, 0), this::observeLeftLane))
                .build()
                .close())
        ...
        .add(
            "Middle Lane",
            (middleLane = new Lane(new Vector(getSize().getX() / 3, 0), this::observeMiddleLane))
                .build()
                .close())
        ...
        .add(
            "Right Lane",
            (rightLane = new Lane(new Vector(getSize().getX() / 3, 0), this::observeRightLane))
                .build()
                .close())
