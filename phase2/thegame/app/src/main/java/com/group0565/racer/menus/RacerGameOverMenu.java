...
public class RacerGameOverMenu extends GameMenu {
  ...
  private static final ThemedPaintCan GAME_OVER_PAINT_CAN =
      new ThemedPaintCan("Racer", "GameOver.GameOver");

  /** ThemedPaintCan for the colour and text of messages */
  private static final ThemedPaintCan MESSAGE_PAINT_CAN =
      new ThemedPaintCan("Racer", "Message.Message");
