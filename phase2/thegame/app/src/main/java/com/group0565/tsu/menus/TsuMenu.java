...
public class TsuMenu extends GameMenu implements Observable {
  ...
  public void init() {
    ...
    this.build()
        ...
        .add(
            TitleButtonName,
            new Button(TITLE_SIZE, getEngine().getGameAssetManager(), SET, TitleButtonBMName)
                .build()
        ...
        .add(
            SettingsMenuName,
            (settingsMenu = new SettingsMenu(SETTINGS_SIZE))
                .build()
                .setEnable(false)
                .setZ(1)
                .close())
        ...
        .add(
            SettingsButtonName,
            new Button(BUTTON_SIZE, ButtonBitmap.SettingsButton.getBitmap())
                .build()
        ...
        .add(
            LanguageButtonName,
            new Button(BUTTON_SIZE, ButtonBitmap.LanguageButton.getBitmap())
                .build()
